    ...
    <>
      <div className="relative h-screen text-white">
        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg;px-32">
          <div className="bg-gradient-to-b from-black via-transparent to- transprent absolute w-full h-full top-0 left-0 -z-10" />
          ...
          <div className="flex mt-8">
            ...
            <Link
              to={`/watch/${trendingContent?.id}`}
              className="bg-gray-500/70 hover:bg-gray-500 text=white py-2 px-4 rounded flex items-center text-white"
            >
